function [next_func_array] = runge_step( func_array,area,stepSize,sw,simType)
...
k1 = equations(old_t,old_a,sw,simType,t0,area);
k2 = equations(old_t + stepSize/2,old_a + (stepSize/2)*k1,sw,simType,t0,area);
k3 = equations(old_t + stepSize/2,old_a + (stepSize/2)*k2,sw,simType,t0,area);
k4 = equations(old_t + stepSize,old_a + stepSize*k3,sw,simType,t0,area);
